...
public class C03_Ortalama {
    ...
    public static void main(String[] args) {
        ...
        //ve bu variable a yazdıgımız 5 sayinin toplamini assign edelim (atayalim)

        double toplam = num1 + num2 + num3 + num4 + num5; //sayisal  (mumeric) datalarda  " + " isareti matematiksel toplama isareti yapar
        System.out.println("toplam =" + toplam);//609.7

         // ortalama = toplam / sayı adeti
